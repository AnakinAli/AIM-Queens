  ...
  internal class Game {
    ...
    public void GameScreen(int turnIndex = 1) {
      ...
      Player currentPlayer =
          Players.AllPlayers.Where(p => p.Id == turnIndex).First();
      ...
      // Validate input
      var validatedInput = Validation.ValidateCoordinates(
          ...
          if (validatedInput == null) {
            Console.ForegroundColor = ConsoleColor.Red;
            animation.TextAnimation(
                $"{animation.Messages["coordinates_error"]}\nWait...");
      ...
      int r = validatedInput[0];
          ...
          Console.WriteLine(nextPlayer); GameScreen(nextPlayer.Id);
    }
  }
}